...
class privecySettings extends StatefulWidget {
  const privecySettings({super.key});

  @override
  State<privecySettings> createState() => _privecySettingsState();
}

class _privecySettingsState extends State<privecySettings> {
